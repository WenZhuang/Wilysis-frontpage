...
<html>
    ...
    <body>
      		...
      		<div class="container">
        		...
        		<div class="navbar-collapse collapse" role="navigation">
          			<ul class="nav navbar-nav navbar-right hidden-sm nav-tabs">
   						<li class="active">
      						<a href="<%=basePath%>index" style="font-size: 18px"><i class="icon-home"></i>&nbsp实时校园</a>
   						</li>
    	...
    	<div class="container" style="width:100%;height:950px;padding-left:0px;padding-right:0px;">
        	<div class="row clearfix" style="margin-left: 0px;margin-right:0px">
        		<div class="col-md-12 column" style="padding-left:0px;padding-right:0px;">
        			...
        			<div id="legend" class=" BMap_noprint anchorBR" style="z-index: 10;padding:0px;">
                           	...
                           	<a class="legend-item legend-1" href="javascript:void(0);">非常稀疏：1         
                              	<div class="legend-item-wrapper">
                                 	<div class="legend-item-tip">
                                                                                                                  非常稀疏：少于10人/100㎡
                                          <span class="legend-item-tip-arrow"></span>
                                    </div>
                                </div>
                           </a>
                           <a class="legend-item legend-2" href="javascript:void(0);">稀疏：2         
                               <div class="legend-item-wrapper">
                                   <div class="legend-item-tip">
                                                                                                                      稀疏：10-20人/100㎡
                                           	<span class="legend-item-tip-arrow"></span>
                           ...
                           <a class="legend-item legend-3" href="javascript:void(0);">一般：3         
                              <div class="legend-item-wrapper">
                                   <div class="legend-item-tip">
                                                                                                                        一般：20-40人/100㎡
                                           	<span class="legend-item-tip-arrow"></span>
                           ...
                           <a class="legend-item legend-4" href="javascript:void(0);">拥挤：4         
                                <div class="legend-item-wrapper">
                                      <div class="legend-item-tip">
                                                                                                                             拥挤：40-60人/100㎡
                                         	<span class="legend-item-tip-arrow"></span>
                           ...
                           <a class="legend-item legend-5" href="javascript:void(0);">非常拥挤：5         
                                <div class="legend-item-wrapper">
                                     <div class="legend-item-tip">
                                                                                                                    非常拥挤：大于60人/100㎡
                                        	<span class="legend-item-tip-arrow"></span>
    ...
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=51dz08mPaRKDUMKPGVGi9rfF"></script>
